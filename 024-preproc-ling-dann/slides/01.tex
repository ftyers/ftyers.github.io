...
\begin{center}
\url{https://ftyers.github.io/079-preproc-ling-dann/index.html}
\end{center}
~\\
\begin{center}
\begin{tabular}{rlrl}
...
In your browser:
\begin{itemize}
  \item First make a repository, call it {\tt 2017-preproc-ling-dann}
...
\begin{verbatim}
$ git clone https://github.com/XXXXXX/2017-preproc-ling-dann.git

$ cd 2017-preproc-ling-dann
...
%%
%%{\small
%%\url{https://ftyers.github.io/079-preproc-ling-dann/materials/UnixForPoets.pdf}
%%}
%%
